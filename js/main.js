...
$(function(){
    cadastrados = localStorage.getItem("cadastrados");// Recupera os dados armazenados
    cadastrados = JSON.parse(cadastrados); // Converte string para objeto
    if(cadastrados == null) // Caso não haja conteúdo, iniciamos um vetor vazio
    cadastrados = [];
});
